...
- Free database of biomedical literature
- Search for: [topic] AND (systematic review OR meta-analysis) for highest-level evidence

**Cochrane Library (cochranelibrary.com)**
- Gold-standard systematic reviews
- Oral health reviews available free or via library access

**Journal of Dental Research**
- Peer-reviewed primary research and reviews
- High-quality but may require library access

**AADR/IADR**
- American and International Associations for Dental Research
- Conferences feature cutting-edge research (often before publication)
