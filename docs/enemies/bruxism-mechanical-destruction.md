...
1. **Distribute forces** across a larger surface area
2. **Protect enamel** by having the grinding occur against acrylic instead of opposing teeth
3. **Provide a sacrificial surface** that wears instead of your teeth
4. **Reduce muscle strain** by putting the jaw in a slightly more relaxed position
...
[^1]: Ferrario, V. F., et al. (2004). Maximum bite forces in healthy young adults as predicted by surface electromyography. *Journal of Dental Research*, 83(4), 286-290.

[^2]: Grippo, J. O., et al. (2004). Abfraction: a new classification of hard tissue lesions of teeth. *Journal of Esthetic and Restorative Dentistry*, 16(5), 306-313.

[^3]: Held, K., et al. (2002). Oral Mg supplementation reverses age-related neuroendocrine and sleep EEG changes in humans. *Pharmacopsychiatry*, 35(4), 135-143.

[^4]: Hoffmann, D. (2003). *Medical Herbalism: The Science and Practice of Herbal Medicine*. Healing Arts Press. Notes valerian's traditional use for nervous tension affecting the musculature.
