...
1. Extend your tongue fully.
2. Place the scraper as far back as comfortable (this takes practice—the gag reflex can be triggered).
3. Apply gentle pressure and draw the scraper forward in one stroke.
4. Rinse the scraper.
5. Repeat 2-3 times, covering the entire dorsal surface.
